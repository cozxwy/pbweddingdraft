...
<main classNames="bg-gray-900 min-h-screen ">
    ...
    <section classNames="bg-white dark:bg-gray-900 antialiased">
  <div classNames="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
    <div classNames="max-w-3xl mx-auto text-center">
      <h2 classNames="text-4xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">
        Schedule
      </h2>

      <div classNames="mt-4">
        <a href="#" title=""
          classNames="inline-flex items-center text-lg font-medium text-primary-600 hover:underline dark:text-primary-500">
           &nbsp;
    ...
    <ol classNames="relative border-l border-gray-200 dark:border-gray-700">                  
    <li classNames="mb-10 ml-6">            
        <span classNames="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
            <svg aria-hidden="true" classNames="w-3 h-3 text-blue-800 dark:text-blue-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path></svg>
        </span>
